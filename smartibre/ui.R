      ...
      tabItem(tabName = "home", 
              div(style = "height: 900px",
                  ...
                  box(
                    ...
                    fluidRow(
                      column(offset = 1, width = 3, img(src = "http://blogdoibre.fgv.br/sites/blogdoibre.fgv.br/themes/libre/logo.png", height = 22)),
                      column(7, 
                             div(style = "font-weight:bold", 
                    ...
                    br(),
                    fluidRow(
                      column(offset = 1, width = 3, img(src = "http://blogdoibre.fgv.br/sites/blogdoibre.fgv.br/files/styles/post_home/public/posts/manuelpires.jpg?itok=GugxM-QW", height = 80)),
                      column(7, 
                             div(style = "font-size:90%; text-align: justify",
                                 "O principal trabalho de um economista é buscar a dimensão correta das questões econômicas envolvidas em um determinado problema. Uma contribuição recente dentro desse espírito foi realizada por Bráulio Borges do IBRE que fez um exercício para avaliar qual o efeito das..."),
                             br(),
                             div(style = "font-size:90%; text-align: center",
                                 a("Clique aqui", href = "http://blogdoibre.fgv.br/posts/o-debate-economico-nao-precisa-de-espantalhos", target = "_blank"), "e leia o artigo completo.")
